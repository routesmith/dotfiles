...
main() {
  ...
  # messages
  set message-style "fg=${thm_green},bg=${thm_bg},align=centre"
  set message-command-style "fg=${thm_bg},bg=${thm_green},align=centre"
  ...
  # Status line during copy mode
  setw mode-style "fg=${thm_fg},bg=${thm_cyan},bold"
  set -g mode-style "fg=${thm_bg},bg=${thm_green},bold"
